...
import 'package:studentapp/views/auth/change_password_screen.dart';
...
class _VerifyOtpScreenState extends State<VerifyOtpScreen> {
  ...
  void _startTimer() {
    Future.delayed(const Duration(seconds: 1), () {
      if (mounted && _isTimerRunning && _remainingSeconds > 0) {
        setState(() {
          _remainingSeconds--;
        });
        _startTimer();
  ...
  String _getMaskedPhoneNumber() {
    ...
    return '${widget.phoneNumber.substring(0, 2)}XXXXXX${widget.phoneNumber.substring(8)}';
  }
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              // Instruction text
                              const Text(
                                'Please enter your one time password sent on',
                                style: TextStyle(
                                  fontSize: 18,
                                  color: AppColors.primaryBlue,
                                ),
...
class DoodleBackgroundPainter extends CustomPainter {
  ...
  void _drawGlobe(canvas, Paint paint, double x, double y) {
